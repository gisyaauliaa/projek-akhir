...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into tb_hubungan values(null, "'+Edit1.Text+'", "'+Edit2.Text+'", "'+ComboBox1.Text+'", "'+ComboBox2.Text+'")');
  ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('update tb_hubungan set siswa_id="'+Edit1.Text+'", ortu_id="'+Edit2.Text+'", status_hub="'+ComboBox1.Text+'", keterangan="'+ComboBox2.Text+'" where id="'+id+'"');
  ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('delete tb_hubungan where id="'+id+'"');
  ZQuery1.ExecSQL;
