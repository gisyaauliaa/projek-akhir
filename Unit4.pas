...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into tb_walikelas values(null, "'+Edit1.Text+'", "'+Edit2.Text+'", "'+ComboBox1.Text+'", "'+Edit3.Text+'", "'+Edit4.Text+'", "'+Edit5.Text+'", "'+ComboBox2.Text+'", "'+ComboBox3.Text+'")');
  ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('update tb_walikelas set nip="'+Edit1.Text+'", nama="'+Edit2.Text+'", jenis_kelamin="'+ComboBox1.Text+'", alamat="'+Edit3.Text+'", telp="'+Edit4.Text+'", matpel="'+Edit5.Text+'", pendidikan="'+ComboBox2.Text+'", status="'+ComboBox3.Text+'" where id="'+id+'"');
  ZQuery1.ExecSQL;
