...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into tb_siswa values(null, "'+Edit1.Text+'", "'+Edit2.Text+'", "'+Edit3.Text+'", "'+Edit4.Text+'", "'+Edit5.Text+'", "'+FormatDateTime('yyyy-mm-dd',DateTimePicker1.Date)+'", "'+ComboBox1.Text+'", "'+ComboBox2.Text+'", "'+ComboBox3.Text+'", "'+Edit6.Text+'", "'+Edit7.Text+'", "'+Edit8.Text+'", "'+Edit9.Text+'", "'+ComboBox4.Text+'")');
  ZQuery1.ExecSQL;
