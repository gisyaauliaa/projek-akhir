...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into tb_poin values(null, "'+Edit1.Text+'", "'+Edit2.Text+'", "'+ComboBox1.Text+'", "'+ComboBox2.Text+'")');
  ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('update tb_poin set nama="'+Edit1.Text+'", bobot="'+Edit2.Text+'", jenis="'+ComboBox1.Text+'", status="'+ComboBox2.Text+'" where id="'+id+'"');
  ZQuery1.ExecSQL;
