...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('insert into tb_poin_siswa values(null, "'+Edit1.Text+'", "'+ComboBox1.Text+'", "'+ComboBox2.Text+'", "'+Edit2.Text+'", "'+Edit3.Text+'", "'+ComboBox3.Text+'", "'+Edit4.Text+'", "'+FormatDateTime('yyyy-mm-dd',DateTimePicker1.Date)+'", "'+ComboBox4.Text+'", "'+ComboBox5.Text+'")');
  ZQuery1.ExecSQL;

  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('select * from tb_poin_siswa');
  ZQuery1.Open;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('update tb_poin_siswa set nama="'+Edit1.Text+'", jenis_kelamin="'+ComboBox1.Text+'", kelas="'+ComboBox2.Text+'", nama_wali="'+Edit2.Text+'", nama_poin="'+Edit3.Text+'", jenis="'+ComboBox3.Text+'", bobot="'+Edit4.Text+'", semester="'+ComboBox4.Text+'", status="'+ComboBox5.Text+'" where id="'+id+'"');
  ZQuery1.ExecSQL;
...
begin
  ZQuery1.SQL.Clear;
  ZQuery1.SQL.Add('delete from tb_poin_siswa where id="'+id+'"');
  ZQuery1.ExecSQL;
